public class Main {
    public static void main(String[] args) {
        Person kolya = new Person("Николай",73,null,null);
        Person sveta = new Person("Светлана",71,null,null);
        Person katya = new Person("Екатерина",70,null,null);
        Person vasya = new Person("Василий", 75,null,null);
        Person oleg = new Person("Олег",45,sveta,kolya);
        Person olga = new Person("Ольга",47, katya,vasya);
